          ...
          <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box">
                  <h1 class="title-single">TAMBAH AGENT</h1>
                ...
                <div class="col-md-12">
                  <form method="POST" action="{{route('admin.agent.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <input type="text" name="no_telp" class="form-control form-control-lg form-control-a" placeholder="Nomor Telephone" required>
                            </div>
                            @error('no_telp')
                                <div style="font-size: 12px; color: red">{{ $message }}</div>
                            @enderror
